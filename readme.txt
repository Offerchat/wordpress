...
1. Navigate to `Plugins Menu > Offerchat` and enter your `API Key` then press Submit button
1. Done! Check your website if the offerchat widget is up.
